...
CREATE TABLE `delivery` (
  ...
  `delivery_status` enum('Pending','Out for Delivery','Delivered','Cancelled') COLLATE utf8mb4_general_ci DEFAULT 'Pending',
...
CREATE TABLE `payment` (
  ...
  `payment_method` enum('Credit Card','Debit Card','PayPal','Cash','Other') COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2025-05-09 20:28:54
